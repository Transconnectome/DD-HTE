...
```{r}
rm(list=ls())
dd_data<-read.csv("C:\\Users\\socra\\Desktop\\Brain discounting\\Data\\ABCD Delay discounting merged_wide_imp dataset.csv", header=TRUE)
...
openxlsx::write.xlsx(list(sheet1=res_spls, sheet2=res_spls_ci), rowNames=TRUE, "C:\\Users\\socra\\Desktop\\Brain Discounting\\Data\\ABCD DD SPLS_results.xlsx")
...
colnames(res_spls_ci)<-c("95% CI: Low", "95% CI: High")
openxlsx::write.xlsx(list(sheet1=res_spls, sheet2=res_spls_ci), rowNames=TRUE, "C:\\Users\\socra\\Desktop\\Brain Discounting\\Data\\ABCD DD SPLS_results2.xlsx")
...
write.csv(res_all, "C:\\Users\\socra\\Desktop\\Brain Discounting\\Data\\ABCD DD IV Regression_results.csv")
...
write.csv(res_all, "C:\\Users\\socra\\Desktop\\Brain Discounting\\Data\\ABCD DD IV Regression_KSADS results.csv")
